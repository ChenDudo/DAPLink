...
def load_bundle_from_project(tool='uvision'):
    ...
    assert (tool in progen_toolchains or tool == 'uvision' or tool == 'uvision5' or tool == 'mbedcli'), 'Input tool %s is not supported' % (tool)
    ...
    if tool in progen_toolchains or tool == 'uvision' or tool == 'uvision5':
