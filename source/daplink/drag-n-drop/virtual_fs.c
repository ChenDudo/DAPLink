...
#define FAT_CLUSTERS_MAX (65525 - 100)	// old is 65535 - 100
...
static const FatDirectoryEntry_t root_dir_entry = {
    ...
    /*uint16_t*/ .creation_date = 0x54B4,
    /*uint16_t*/ .accessed_date = 0x54B4,
    /*uint16_t*/ .first_cluster_high_16 = 0x0000,
    /*uint16_t*/ .modification_time = 0x2A80,
    /*uint16_t*/ .modification_date = 0x54B4,
